...
check("trades or closed", len(b.trades) + len(b.closed_trades) > 0)
...
check("any trades or closes", len(b.trades) + len(b.closed_trades) > 0, "open=%d closed=%d" % (len(b.trades), len(b.closed_trades)))
...
check("trades or closed >0", len(b.trades) + len(b.closed_trades) > 0)
